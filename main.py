...
def main(page: ft.Page):
    ...
    imagen_base64 = convertir_imagen_base64("assets/imagen2.jpg")
    filas = []
        ...
        [
            ft.Column(
                [
                    ...
                    ft.Row([ft.Text("Ejecutivo Comercial:"), ft.TextField(value="Araceli Quiroz", width=200)]),
                    ...
                    ft.Row([ft.Text("Fecha de Vencimiento:"), ft.TextField(value="30-01-2024", width=200)]),
            ...
            ft.Column(
                [
                    ft.Row([ft.Text("Descuento Máximo:"), ft.TextField(value="0%", width=100)]),
                    ft.Row([ft.Text("Descuento:"), ft.TextField(value="0%", width=100)]),
                    ft.Row([ft.Text("Tipo Construcción:"), ft.TextField(value="Incombustible", width=200)]),
                    ft.Row([ft.Text("Zona/Región:"), ft.TextField(value="Región 13 Metropolitana", width=250)]),
                    ft.Row([ft.Text("Borde Costero - nivel del mar:"), ft.TextField(value="No", width=100)]),
            ...
            ft.Column(
                [
                    ...
                    ft.Row([ft.Text("Inc. y adic."), ft.TextField(value="45", width=100)]),
